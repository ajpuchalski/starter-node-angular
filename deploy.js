...
function cloneRepo() {
	...
	cmd.get(
		'rm -rf starter-node-angular && git clone https://github.com/ajpuchalski/starter-node-angular',
...
function transferProjectToRemote(failed, successful) {
	return ssh.putDirectory(__dirname + '/starter-node-angular', '/home/ubuntu/starter-node-angular', {
		recursive: true,
		concurrency: 1,
...
function createRemoteTempFolder() {
	return ssh.execCommand('rm -rf starter-node-angular && mkdir starter-node-angular', { cwd:'/home/ubuntu' })
}
...
function updateRemoteApp() {
	return ssh.execCommand('cp -r starter-node-angular/* starter-node-angular/ && rm -rf starter-node-angular/*', { cwd:'/home/ubuntu' })
}
